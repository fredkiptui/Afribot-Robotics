<section class="parallax-container section" style="background: #16A2BE;">
        <div class="parallax-content section-lg context-dark text-center parallax-overlay-gradient-primary">
          <div class="container wow fadeIn">
            ...
            <div class="block-lg block-center">
              ...
              <h3>REGISTER NOW</h3>
              <p>Join us at the upcoming AI & Robotics Conference! Discover the latest advancements in artificial intelligence and robotics, and gain valuable insights from industry leaders and experts.</p>
              <p> <b> Limited spots are available, so sign up now to secure your place! </b> </p>
              <!-- Countdown rectangle-->
              <div class="countdown countdown-rect" data-countdown="data-countdown" data-to="2023-9-31">
